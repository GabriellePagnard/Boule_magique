document.addEventListener('DOMContentLoaded', () => {
    ...
    getAnswerButton.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            blurredLayer.classList.add('w-full', 'h-full', 'object-cover', 'rounded-full', 'absolute', 'top-0', 'left-0', 'blur-sm');
            ...
            flippedImage.classList.add('w-full', 'h-full', 'object-cover', 'rounded-full', 'absolute', 'top-0', 'left-0');
    ...
    askAnotherButton.addEventListener('click', () => {
        ...
        const flippedImage = ballContainer.querySelector("img[alt='Boule Magique Verso']");
        if (flippedImage) {
            flippedImage.remove();
        }
